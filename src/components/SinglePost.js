...
export default function SinglePost() {
    ...
    return (
        <main className='bg-grey-200 min-h-screen p-12'>
            <article className='container shadow-lg mx-auto bg-green-60 rounded-large'>
                <header className='relative'>
                    <div className='absolute h-full w-full flex items-center justify-center p-8'>
                        <div className='bg-white bg-opacity-75 rounded p-12'>
                            <h1 className='greeting text-3xl lg:text-6xl mb-4'>
                                {singlePost.title}
                            </h1>
                            <div className='flex justify-center text-gray-800'>
                                ...
                                />
                                <p className='greeting flex items-center pl-2 text-2xl'></p>
                            </div>
                        </div>
                    </div>
                    <img 
